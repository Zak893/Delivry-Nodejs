<template>
  <div>
    <h3 class="profile__name">LET'S DO THIS</h3>
    <div class="account__info">
      <h2 class="account__title">departure address & package weight</h2>
...
export default {
  ...
  methods: {
    ...
    async saveChangeClick() {
      ...
      try {
        const response = await axios.post('/add-ordre', {
          email: localStorage.getItem('userEmail'), // Obtenez l'identifiant de l'utilisateur à partir des données Vuex
